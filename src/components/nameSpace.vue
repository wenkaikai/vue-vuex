...
const store = new Vuex.Store({
   ...
   mutations:{
    global(a,b,c){
      console.log(a) // 这个是全局的state
      console.log(b) // 这个是模块a 传过来的参数
      console.log("我是全局的mutation")
    }
   }
})
...
export default {
    ...
    methods: {
        increment() {
          // 要触发命名空间下的要加上模块的名字 比如此时我们的模块是 a ,我们加上a 就好了
          this.$store.dispatch("a/test")
